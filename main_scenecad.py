...
def get_args_parser():
    ...
    parser.add_argument('--lr_drop', default=[320], type=list)#520
    ...
    parser.add_argument('--resume', default='/home/lyy/edge/output/2025-04-18-10-00-50_edge_dn_swinv2ceweight1_coord6_raster1/checkpoint.pth', help='resume from checkpoint')
